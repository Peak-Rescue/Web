      ...
      <div className="mb-6 p-4 bg-zinc-900 rounded-lg border border-zinc-800 space-y-4">
        ...
        <div className="flex items-center justify-between pt-1">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded font-medium text-sm transition-colors disabled:opacity-40 disabled:cursor-not-allowed bg-pr-red hover:bg-pr-red-dark text-white"
          >
