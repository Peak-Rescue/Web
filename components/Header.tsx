...
export default function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => setScrolled(prev => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 bg-pr-bg/95 backdrop-blur-md transition-all duration-300 ${
          scrolled || menuOpen ? 'border-b border-white/[0.06]' : 'border-b border-transparent'
        }`}
      >
