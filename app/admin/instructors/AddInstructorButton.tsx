...
export default function AddInstructorButton() {
  ...
  return (
    <>
      <button
        onClick={openModal}
        className="flex items-center gap-2 px-4 py-2 rounded font-medium text-sm bg-pr-red hover:bg-pr-red-light text-white transition-colors"
      >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-1">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded text-sm font-medium bg-pr-red hover:bg-pr-red-light text-white transition-colors disabled:opacity-50"
                >
