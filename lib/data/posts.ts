...
export const posts: Post[] = [
  {
    slug: 'influencers-in-the-wild',
    title: 'Influencers in the Wild',
    date: 'March 18, 2023',
    excerpt:
    ...
    body: [
      ...
      'It is therefore essential that those who seek to become influencers in the rescue world stay true to the craft. They must be committed to ongoing learning and training to maintain their expertise and credibility. They must prioritize safety and ethical considerations over social media metrics. And they must be willing to put in the hard work necessary to become skilled practitioners in their field.',
      'One of the concerns with influencers in any field is that they may prioritize popularity over quality. They may be more concerned with getting likes and followers than with providing accurate, reliable information. In the technical rescue world, this can be flat out dangerous. Inaccurate information or techniques can lead to mistakes, injuries, or even fatalities.',
      'To stay true to the craft, tech rescue influencers must prioritize accuracy and safety in their content. They should only share techniques and information that they have personally tested and verified. They must be willing to admit when they don\'t know something and seek out the expertise of others. And they must be willing to hold themselves accountable for the information they put out into the world.',
      'In the end, it\'s possible to enjoy social media and still be committed to the craft of tech rescue. Ultimately, becoming an influencer in today\'s rescue world is not about popularity or likes. It\'s about using social media to share valuable information, raise awareness about the importance of technical rescue, and connect with others in the field. Those who stay true to the craft, prioritize safety and accuracy, and commit to ongoing learning and training will be the ones who truly make a difference in the rescue world. I have to stop writing now as I have to post on my social media.',
      'Stay frosty my friends',
    ],
  },
  {
    slug: 'teaching-rope-rescue-tech-savvy-era',
    title: 'Teaching Rope Rescue in a Tech-Savvy Era: The Importance of Math and Simple Systems',
    date: 'February 5, 2023',
    excerpt:
      'Mathematical principles still underpin every rescue system. How we bridge the gap between modern tech and timeless mechanics.',
    image: '/images/blog/teaching-rope-rescue-tech-savvy-era.jpeg',
    body: [
  ...
  {
    slug: 'rescue-for-you',
    title: 'Rescue For You',
    date: 'March 15, 2019',
    excerpt:
      'A reflection on what it means to train rescue teams — and why the best training happens when it gets uncomfortable.',
    image: '/images/blog/rescue-for-you.jpg',
    body: [
  ...
  {
    slug: 'my-gear-mance-asap',
    title: 'My Gear-mance: The ASAP and ASAP Lock',
    date: 'March 15, 2019',
    excerpt:
