...
export const instructors: Instructor[] = [
  {
    ...
    certifications: ['IFMGA/UIAGM Mountain Guide', 'SPRAT Level 3', 'Paramedic', 'Swiftwater Rescue Technician', 'Avalanche Educator'],
    specialties: ['mountain-rope-rescue', 'mountain-mobility-training', 'fall-protection-rope-access'],
  ...
  },
  {
    ...
    certifications: ['Firefighter/EMT-I', 'SPRAT Level 3', 'Hazmat Technician', 'Confined Space Rescue Technician', 'High Angle Rescue Technician'],
    specialties: ['confined-space-rescue', 'fall-protection-rope-access', 'emergency-response-team'],
  ...
  },
  {
    ...
    certifications: ['SPRAT Level 3', 'Wildland Firefighter', 'Structure Firefighter', 'Vehicle Extrication', 'Technical Rescue Technician'],
    specialties: ['emergency-response-team', 'small-team-rescue', 'urban-mobility'],
  ...
  },
  {
    ...
    specialties: ['mountain-mobility-training', 'mountain-rope-rescue', 'canyoneering'],
  ...
  },
  {
    ...
    specialties: ['fall-protection-rope-access', 'urban-mobility', 'confined-space-rescue'],
  ...
  },
  {
    ...
    specialties: ['swiftwater-rescue', 'mountain-rope-rescue', 'canyoneering'],
  ...
  },
  {
    ...
    name: 'Tyler Anderson',
    role: 'specialized',
    title: 'Instructor — Emergency Response',
    bio: 'A native of West Virginia, Tyler Anderson grew up climbing and caving throughout the hills of Appalachia, cultivating a deep connection with technical rescue environments. With over 15 years as a first responder, Tyler has extensive experience handling local, state, and federal incidents. He earned his bachelor\'s degree from West Virginia University and a master\'s degree in homeland security from Pennsylvania State University, then worked as a technical advisor in emergency services for a defense contractor. Tyler is currently a principal member of the NFPA 2500 Technical Search and Rescue Committee, serves on the ASTM F32 Committee on Technical Search and Rescue, and contributes to the West Virginia Office of EMS Rescue Medicine Committee. He has twice presented at the Special Operations Medical Association Scientific Assembly. He holds certifications in vehicle extrication, rope, water, trench, collapse, confined space, and cave rescue.',
    certifications: ['Wilderness EMT', 'Hazardous Materials Specialist', 'IFSAC Instructor II', 'IFSAC Fire Officer II'],
    specialties: ['emergency-response-team', 'confined-space-rescue', 'firefighter-survival'],
    avatar: '/images/instructors/tyler-anderson.jpg',
  ...
  },
  {
    ...
    certifications: ['ACA L5 Rafting Instructor Trainer', 'ACA L5 Advanced Swiftwater Rescue Instructor', 'icoPRO Level 3 Canyoning', 'Technical Rope Rescue'],
