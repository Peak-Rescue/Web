...
export const PURPOSE_META: Record<LinkPurpose, { label: string; hint: string; verb: string }> = {
  photos: {
    label: 'Photos',
  ...
  resource: {
    label: 'Resources',
    hint: 'Anything useful for this delivery only. Reusable material belongs in the library',
    verb: 'Add a resource',
  },
  form: {
