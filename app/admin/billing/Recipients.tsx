...
//
// Only that. Whoever reads a course's numbers is a different list on the same
// page (report_recipients) and deliberately not a tick on this one: these
// people hold a token to a billing queue, and a reader of a P&L has no
// business with one.
//
